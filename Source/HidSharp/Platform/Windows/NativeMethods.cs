...
namespace HidSharp.Platform.Windows
{
    ...
    {
        public static readonly Guid GuidForBluetoothLEDevice = new("{781AEE18-7733-4CE4-ADD0-91F41C67B592}");
        public static readonly Guid GuidForBluetoothHciEvent = new("{FC240062-1541-49BE-B463-84C4DCD7BF7F}");
        public static readonly Guid GuidForBluetoothRadioInRange = new("{EA3B5B82-26EE-450E-B0D8-D26FE30A3869}");
        public static readonly Guid GuidForBluetoothRadioOutOfRange = new("{E28867C9-C2AA-4CED-B969-4570866037C4}");
        public static readonly Guid GuidForComPort = new("{86E0D1E0-8089-11D0-9CE4-08003E301F73}");
        public static readonly Guid GuidForPortsClass = new("{4D36E978-E325-11CE-BFC1-08002BE10318}");
        public static readonly Guid GuidForUsbHub = new("{F18A0E88-C30C-11D0-8815-00A0C906BED8}");
